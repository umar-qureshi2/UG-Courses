...
namespace System_App
{
    public class TCPHeader
    {
        ...
        private byte[] byTCPData = new byte[8192];//Data carried by the TCP packet
        ...
        public TCPHeader(byte [] byBuffer, int nReceived)
        {
            ...
            {
                //MessageBox.Show(ex.Message, "TCP Err" + (nReceived), MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
