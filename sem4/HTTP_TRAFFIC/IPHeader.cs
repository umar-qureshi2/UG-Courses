...
namespace System_App
{
    ...
    public class IPHeader
    {
        ...
        private byte[]    byIPData = new byte[8192];  //Data carried by the datagram


        public IPHeader(byte[] byBuffer, int nReceived) // constructor
        {
        ...
        {
            //MessageBox.Show(ex.Message, "IP Err", MessageBoxButtons.OK, MessageBoxIcon.Error);
        }
        }
